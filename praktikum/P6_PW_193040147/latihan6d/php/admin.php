    ...
    <table border="1" cellpadding="13" cellspacing="0">
        ...
        <?php foreach($makanan as $nama) : ?>
            <tr>
                <td><?= $i; ?></td>
                <td>
                    <a href=""><button>ubah.php?no=<?= $nama['id']; ?>"><button>Ubah</button></a>
                    <a href=""><button>hapus.php?no=<?= $nama['id']; ?>" onclick="return confirm('Hapus data?');"><button>Hapus</button></a></button></a>
                </td>
